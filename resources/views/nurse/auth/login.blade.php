...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Login: Nurse') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ url('/nurse/login') }}">
                            @csrf

                            <div class="form-group row">
                                <label for="access_id" class="col-md-4 col-form-label text-md-right">{{ __('Access ID') }}</label>
